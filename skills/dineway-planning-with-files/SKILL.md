---
name: dineway-planning-with-files
version: "2.10.1"
...
hooks:
  ...
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
        - type: command
          command: "echo '[dineway-planning-with-files] File updated. If this completes a phase, update task_plan.md status.'"
  Stop:
    - hooks:
        - type: command
          command: |
            SCRIPT_DIR="${CODEX_SKILL_ROOT:-$HOME/.codex/skills/dineway-planning-with-files}/scripts"
...
- **Templates** are in `.codex/skills/dineway-planning-with-files/templates/`
- **Your planning files** go in **your project directory**

| Location                                                       | What Goes There                              |
| -------------------------------------------------------------- | -------------------------------------------- |
| Skill directory (`.codex/skills/dineway-planning-with-files/`) | Templates, scripts, reference docs           |
...
- `scripts/session-catchup.mjs` — Recover context from previous session (v2.2.0)
